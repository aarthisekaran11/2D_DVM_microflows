...
contains
  ...
  subroutine read_input_grvy( input_filename, vel_grid_filename )
    ...
    integer :: nx_space, ny_space, num_zones
    ...
    integer, allocatable, dimension(:) :: InitC, shock_thickness, shock_middle
    ...
    integer :: coll_limit, RotColl, VibColl
    ...
    call set_physical_grid( nx_space, delta_x, ny_space, delta_y, num_zones )
    ...
    !===============================================================================================
    allocate( InitC(1:num_species), shock_thickness(1:num_species), shock_middle(1:num_species), STAT=status )
    ...
    call grvy_input_fread_int_vec( 'boundary/shock_middle', shock_middle, num_species, status )
    call set_spatial_domain_conditions( InitC, shock_thickness, shock_middle )
    ...
    do n = 1, num_species
       ...
       call set_boundary_properties( dens_LW, u_LW, v_LW, w_LW, tr_temp_LW, &
            dens_RW, u_RW, v_RW, w_RW, tr_temp_RW, n )
