...
contains
  ...
  subroutine read_input_grvy( input_filename, vel_grid_filename )
    ...
    double precision :: dens_LW, u_LW, v_LW, w_LW, tr_temp_LW, rot_temp_LW, vib_temp_LW
    double precision :: dens_RW, u_RW, v_RW, w_RW, tr_temp_RW, rot_temp_RW, vib_temp_RW
    double precision :: dens_BW, u_BW, v_BW, w_BW, tr_temp_BW, rot_temp_BW, vib_temp_BW
    double precision :: dens_TW, u_TW, v_TW, w_TW, tr_temp_TW, rot_temp_TW, vib_temp_TW
    ...
    !===============================================================================================
    call grvy_input_fread_double( 'reference/Kn', Kn, status )

    call set_knudsen_number( Kn )

    call grvy_input_fread_double( 'reference/Lc', Lc, status )
    ...
    call grvy_input_fread_int( 'phy_grid/nx_space', nx_space, status )

    call grvy_input_fread_double( 'phy_grid/delta_y', delta_y, status )
    call grvy_input_fread_int( 'phy_grid/ny_space', ny_space, status )
    ...
    call grvy_input_fread_int_vec( 'boundary/spatial_middle', spatial_middle, num_species, status )
    ...
    call grvy_input_fread_int( 'boundary/BWallBC', BWallBC, status )
    call grvy_input_fread_int( 'boundary/TWallBC', TWallBC, status )
    ...
    do n = 1, num_species
       call grvy_input_fread_double_ivec( 'boundary/dens_init', dens_init, n, status )
       call grvy_input_fread_double_ivec( 'boundary/x_vel_init', u_init, n, status )
       call grvy_input_fread_double_ivec( 'boundary/y_vel_init', v_init, n, status )
       call grvy_input_fread_double_ivec( 'boundary/z_vel_init', w_init, n, status )
       call grvy_input_fread_double_ivec( 'boundary/tr_temp_init', tr_temp_init, n, status )
       call grvy_input_fread_double_ivec( 'boundary/rot_temp_init', rot_temp_init, n, status )
       call grvy_input_fread_double_ivec( 'boundary/vib_temp_init', vib_temp_init, n, status )

       call grvy_input_fread_double_ivec( 'boundary/dens_LW', dens_LW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/x_vel_LW', u_LW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/y_vel_LW', v_LW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/z_vel_LW', w_LW, n, status )
       ...
       call grvy_input_fread_double_ivec( 'boundary/x_vel_RW', u_RW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/y_vel_RW', v_RW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/z_vel_RW', w_RW, n, status )
       ...
       call grvy_input_fread_double_ivec( 'boundary/dens_BW', dens_BW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/x_vel_BW', u_BW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/y_vel_BW', v_BW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/z_vel_BW', w_BW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/tr_temp_BW', tr_temp_BW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/rot_temp_BW', rot_temp_BW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/vib_temp_BW', vib_temp_BW, n, status )

       call grvy_input_fread_double_ivec( 'boundary/dens_TW', dens_TW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/x_vel_TW', u_TW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/y_vel_TW', v_TW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/z_vel_TW', w_TW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/tr_temp_TW', tr_temp_TW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/rot_temp_TW', rot_temp_TW, n, status )
       call grvy_input_fread_double_ivec( 'boundary/vib_temp_TW', vib_temp_TW, n, status )
...
!!$    call set_coll_limit( coll_limit )
    call grvy_input_fread_double( 'collision/cdf_tolerance', cdf_tolerance, status )
